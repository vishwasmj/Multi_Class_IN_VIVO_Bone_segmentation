...
def finetuned_U_Net_VGG19():

    input_img_shape = (512, 512, 3)
    VGG19_encoder = vgg19.VGG19(include_top=False, weights='imagenet', input_shape=input_img_shape)
    last_feature_extraction_layer = VGG19_encoder.output
    ...
    concat_1 = concatenate([fine_tuned_u_net_model,VGG19_encoder.get_layer("block5_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_2 = concatenate([fine_tuned_u_net_model ,VGG19_encoder.get_layer("block4_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512, (1, 1), strides=(1, 1))(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_3 = concatenate([fine_tuned_u_net_model,VGG19_encoder.get_layer("block3_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_4 = concatenate([fine_tuned_u_net_model ,VGG19_encoder.get_layer("block2_conv2").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_5 = concatenate([fine_tuned_u_net_model ,VGG19_encoder.get_layer("block1_conv2").output])
    ...
    fine_tuned_u_net_model = Model(VGG19_encoder.input ,fine_tuned_u_net_model)
