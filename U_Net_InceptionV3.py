...
def finetuned_U_Net_InceptionV3():

    input_img_shape = (512, 512, 3)
    inceptionv3_encoder = inceptionv3.INCEPTIONV3(include_top=False, weights='imagenet', input_shape=input_img_shape)
    last_feature_extraction_layer = inceptionv3_encoder.output

    ## Freezing extraction layers
    set_trainable = False
    for layer in inceptionv3_encoder.layers:
    ...
    concat_1 = concatenate([fine_tuned_u_net_model,inceptionv3_encoder.get_layer("block5_conv3").output])


    fine_tuned_u_net_model = Conv2D(512 ,(2 ,2) ,strides=(1, 1) ,padding='same')(concat_1)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512 ,(2 ,2) ,strides=(1, 1) ,padding='same')(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512, (2, 2), strides=(2, 2), padding='same')(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_2 = concatenate([fine_tuned_u_net_model ,inceptionv3_encoder.get_layer("block4_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512, (1, 1), strides=(1, 1), padding='same')(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_3 = concatenate([fine_tuned_u_net_model,inceptionv3_encoder.get_layer("block3_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_4 = concatenate([fine_tuned_u_net_model ,inceptionv3_encoder.get_layer("block2_conv2").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_5 = concatenate([fine_tuned_u_net_model ,inceptionv3_encoder.get_layer("block1_conv2").output])
    ...
    fine_tuned_u_net_model = Model(inceptionv3_encoder.input ,fine_tuned_u_net_model)
...
# fine_tuned_u_net_model = sm.Unet(pre_train_encoder, encoder_weights='imagenet', classes= target_class, activation = activation_function)