from keras.applications import seresnet50
...
def finetuned_U_Net_SEResnet50():

    input_img_shape = (512, 512, 3)
    SERESNET50_encoder = seresnet50.RESNET50(include_top=False, weights='imagenet', input_shape=input_img_shape)
    last_feature_extraction_layer = SERESNET50_encoder.output

    ## Freezing extraction layers
    set_trainable = False
    for layer in SERESNET50_encoder.layers:
    ...
    concat_1 = concatenate([fine_tuned_u_net_model,SERESNET50_encoder.get_layer("block5_conv3").output])


    fine_tuned_u_net_model = Conv2D(512 ,(3 ,3) ,strides=(1, 1) ,padding='same')(concat_1)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512 ,(3 ,3) ,strides=(2, 2) ,padding='same')(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_2 = concatenate([fine_tuned_u_net_model ,SERESNET50_encoder.get_layer("block4_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512, (2, 2), strides=(3, 3))(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(512, (1, 1), strides=(2, 2))(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_3 = concatenate([fine_tuned_u_net_model,SERESNET50_encoder.get_layer("block3_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_4 = concatenate([fine_tuned_u_net_model ,SERESNET50_encoder.get_layer("block2_conv2").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_5 = concatenate([fine_tuned_u_net_model ,SERESNET50_encoder.get_layer("block1_conv2").output])
    ...
    fine_tuned_u_net_model = Model(SERESNET50_encoder.input ,fine_tuned_u_net_model)
