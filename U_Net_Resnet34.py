...
def finetuned_U_Net_Resnet34():

    input_img_shape = (512, 512, 3)
    RESNET34_encoder = resnet34.RESNET34(include_top=False, weights='imagenet', input_shape=input_img_shape)
    last_feature_extraction_layer = RESNET34_encoder.output

    ## Freezing extraction layers
    set_trainable = False
    for layer in RESNET34_encoder.layers:
    ...
    concat_1 = concatenate([fine_tuned_u_net_model,RESNET34_encoder.get_layer("block5_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_2 = concatenate([fine_tuned_u_net_model ,RESNET34_encoder.get_layer("block4_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_3 = concatenate([fine_tuned_u_net_model,RESNET34_encoder.get_layer("block3_conv3").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_4 = concatenate([fine_tuned_u_net_model ,RESNET34_encoder.get_layer("block2_conv2").output])
    ...
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    fine_tuned_u_net_model = Conv2DTranspose(128, (2, 2), strides=(1, 1), padding='same')(fine_tuned_u_net_model)
    fine_tuned_u_net_model = LeakyReLU(0.1)(fine_tuned_u_net_model)
    fine_tuned_u_net_model = BatchNormalization()(fine_tuned_u_net_model)
    concat_5 = concatenate([fine_tuned_u_net_model ,RESNET34_encoder.get_layer("block1_conv2").output])
    ...
    fine_tuned_u_net_model = Model(RESNET34_encoder.input ,fine_tuned_u_net_model)
